...
__C.DISENTANGLE.DISENTANGLE = True

__C.DISENTANGLE.KWARGS = CN(new_allowed=True)

__C.DISENTANGLE.TYPE = "Split_fb"
...
__C.RECONSTRUCTION.IKWARGS = CN(new_allowed=True)

__C.RECONSTRUCTION.MKWARGS = CN(new_allowed=True)
