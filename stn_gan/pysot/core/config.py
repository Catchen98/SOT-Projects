...
__C.DATASET.NAMES = ('VID', 'COCO', 'DET', 'YOUTUBEBB', 'MOT','DAVIS')
...
__C.DATASET.DAVIS = CN()
__C.DATASET.DAVIS.ROOT = 'DAVIS/JPEGImages/480p'
__C.DATASET.DAVIS.ANNO = 'DAVIS/Annotations/480p'
__C.DATASET.DAVIS.FRAME_RANGE = 3
__C.DATASET.DAVIS.NUM_USE = -1
...
__C.RECONSTRUCTION = CN()

__C.RECONSTRUCTION.RECONSTRUCTION = True

__C.RECONSTRUCTION.TYPE = 'Reconstruction'

__C.RECONSTRUCTION.KWARGS = CN(new_allowed=True)

__C.DISCRIMINATOR = CN()

__C.DISCRIMINATOR.DISCRIMINATOR = True

__C.DISCRIMINATOR.TYPE = "Discriminator"

__C.DISCRIMINATOR.KWARGS = CN(new_allowed=True)
# ------------------------------------------------------------------------ #
