...
def main(tracktor, _config, _log, _run):
    ...
    obj_detect_state_dict = torch.load(_config['tracktor']['obj_detect_weights'])
    # embed()
    ...
    if 'oracle' in tracktor:
        ...
        # tracker = OracleTracker(obj_detect, tracktor['tracker'], tracktor['oracle'])
    else:
