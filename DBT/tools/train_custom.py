...
def main():
    ...
    for e in range(cfg.total_epochs):
        ...
        print(args.work_dir.split('/')[-2],'i:',i,'epoch:',epoch,'video_id:',video_id,'reference_id:',reference_id,'loss_rpn_cls:',log_vars['loss_rpn_cls'],'loss_rpn_bbox:',log_vars['loss_rpn_bbox'],
