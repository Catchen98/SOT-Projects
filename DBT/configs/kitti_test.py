...
load_from = 'snapshot/r101/epoch_40.pth'#'checkpoints/faster_rcnn_r101_fpn_1x_20181129-d1468807.pth'#'./checkpoints/faster_rcnn_r50_fpn_1x_20181010-3d1b3351.pth'
resume_from = None
workflow = [('train', 1)]
