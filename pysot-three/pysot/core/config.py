...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/databack/data/vid/crop511'
__C.DATASET.VID.ANNO = '/databack/data/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.FT3D = CN()
__C.DATASET.FT3D.ROOT = '/databack/FlyingThings3D_subset/train/crop127'
__C.DATASET.FT3D.FLOW = '/databack/FlyingThings3D_subset/train/crop_flow127'
__C.DATASET.FT3D.FRAME_RANGE = 1
__C.DATASET.FT3D.NUM_USE = 100000

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/databack/data/yt_bb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '/databack/data/yt_bb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/databack/data/coco/crop511'
__C.DATASET.COCO.ANNO = '/databack/data/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/databack/data/det/crop511'
__C.DATASET.DET.ANNO = '/databack/data/det/train.json'
...
__C.COMMONSENSE.COMMONSENSE = False

__C.COMMONSENSE.TYPE = 'Explicit_corr'

__C.COMMONSENSE.KWARGS = CN(new_allowed=True)

__C.DEFORMABLE = CN()

__C.DEFORMABLE.DEFORMABLE = False

__C.DEFORMABLE.TYPE = 'DeformConvNet'

__C.DEFORMABLE.KWARGS = CN(new_allowed=True)
...
__C.TSF.KWARGS = CN(new_allowed=True)
